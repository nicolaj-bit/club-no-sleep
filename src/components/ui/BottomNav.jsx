  ...
  return (
    <>
      {menuOpen && (
        ...
        >
          <div
            className="absolute bottom-28 left-1/2 -translate-x-1/2 w-72 bg-white rounded-3xl shadow-2xl overflow-hidden"
        ...
        >
          <Link
            ...
            className={cn(
              ...
              isActive('Home') ? "text-stone-900" : "text-stone-400 hover:text-stone-600"
            )}
          >
