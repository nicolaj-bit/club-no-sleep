...
import { ChevronDown, ChevronUp, Baby, Heart, Sparkles, ArrowRight } from 'lucide-react';
      ...
      {open && (
        <div className="px-4 pb-4 space-y-3 border-t" style={{ borderColor: 'var(--color-border)' }}>
          ...
          <Link
            ...
            className="flex items-center justify-between w-full px-4 py-3 rounded-xl border font-medium text-sm transition-opacity active:opacity-70"
