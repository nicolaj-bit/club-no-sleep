    ...
    <div style={{ fontFamily: 'Inter, -apple-system, sans-serif', backgroundColor: '#FAF6F1', color: '#2B1F16', overflowX: 'hidden' }}>
      ...
      <section style={{
        ...
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, backgroundColor: 'rgba(91,63,43,0.08)', borderRadius: 100, padding: '6px 16px', marginBottom: 24 }}>
          <span style={{ fontSize: '0.75rem', fontWeight: 600, color: '#5B3F2B', letterSpacing: '0.08em', textTransform: 'uppercase' }}>📱 Din babys bedste start</span>
        </div>
        ...
        <h1 style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', fontSize: 'clamp(2.8rem, 8vw, 5.5rem)', fontWeight: 400, lineHeight: 1.05, color: '#2B1F16', marginBottom: 24, maxWidth: 700 }}>
          Søvn, trivsel &<br />
          <span style={{ color: '#C29A73', fontStyle: 'italic' }}>fællesskab</span><br />
          for hele familien
        </h1>

        <p style={{ fontSize: 'clamp(1rem, 2.5vw, 1.2rem)', color: '#7A665A', lineHeight: 1.7, maxWidth: 520, marginBottom: 40 }}>
          LALATOTO-appen hjælper dig med søvnlog, tigerspring, graviditetsdagbog og et trygt community — alt samlet ét sted.
        </p>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, justifyContent: 'center', marginBottom: 48 }}>
          ...
          <a href={GOOGLE_PLAY_URL} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, backgroundColor: '#1C1C1E', borderRadius: 16, padding: '12px 24px', cursor: 'pointer', minWidth: 180 }}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="white">
                <path d="M3.18 23.76c.3.16.64.22.99.15l12.5-7.07-2.83-2.83-10.66 9.75zm-1.15-19.3C1.72 4.8 1.5 5.18 1.5 5.65v12.7c0 .47.22.85.53 1.08l.1.07 7.12-7.12v-.17L2.13 4.39l-.1.07zm16.47 8.66L15.74 11l-3.02 3.02 2.76 2.76 3.02-1.73c.86-.5.86-1.43 0-1.93zM4.17.24L16.67 7.3l-2.83 2.83L3.18.38C3.53.31 3.87.09 4.17.24z"/>
              </svg>
              <div style={{ textAlign: 'left' }}>
        ...
        <div style={{ position: 'relative', maxWidth: 300, width: '100%' }}>
          <img
            src="https://www.lalatoto.dk/cdn/shop/files/lalatoto-app-mockup.png"
            alt="LALATOTO app"
            onError={e => { e.target.style.display = 'none'; }}
            style={{ width: '100%', filter: 'drop-shadow(0 30px 60px rgba(91,63,43,0.25))', borderRadius: 32 }}
          />
          {/* Fallback phone mockup if image 404s */}
      ...
      <section id="features" style={{ padding: '80px 24px', maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 56 }}>
          <p style={{ fontSize: '0.75rem', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#C29A73', marginBottom: 12 }}>Alt i én app</p>
          <h2 style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', fontSize: 'clamp(2rem, 5vw, 3.5rem)', fontWeight: 400, color: '#2B1F16', lineHeight: 1.1 }}>
            Designet til <span style={{ fontStyle: 'italic', color: '#C29A73' }}>dig</span>
          </h2>
        </div>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24 }}>
          {[
            { emoji: '🌙', title: 'Søvnlog', desc: 'Log barnets søvn dag for dag. Se mønstre, natlige opvågninger og lur-statistik — og få AI-råd til bedre nætter.' },
            { emoji: '🐯', title: 'Tigerspring', desc: 'Bliv guidet gennem alle 10 mentale udviklingsspring. Forstå dit barn bedre og ved hvornår det næste spring kommer.' },
            { emoji: '🤰', title: 'Graviditetsdagbog', desc: 'Følg graviditeten uge for uge. Skriv dine tanker, noter symptomer og gem mavebilleder fra hele rejsen.' },
            { emoji: '📅', title: 'Kalender', desc: 'Hold styr på jordemoder, scanning og lægebesøg. Få påmindelser dagen før og 30 min inden.' },
            { emoji: '💬', title: 'Community', desc: 'Find mødre i nærheden der også er vågne om natten. Et trygt rum kun for mødre — fri for natteensomhed.' },
            { emoji: '🤖', title: 'AI-søvnekspert', desc: 'Få personlige svar baseret på jeres søvndata. Vores AI er trænet i babysøvn, amning og barnets udvikling.' },
            ...
            >
              ...
              <p style={{ fontSize: '0.9rem', color: '#7A665A', lineHeight: 1.7 }}>{desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="benefits" style={{ backgroundColor: '#2B1F16', padding: '80px 24px' }}>
        <div style={{ maxWidth: 900, margin: '0 auto', textAlign: 'center' }}>
          <p style={{ fontSize: '0.75rem', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#C29A73', marginBottom: 12 }}>Hvorfor LALATOTO?</p>
          <h2 style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', fontSize: 'clamp(2rem, 5vw, 3.5rem)', fontWeight: 400, color: '#F5EFE9', lineHeight: 1.1, marginBottom: 48 }}>
            Alt det en forælder <span style={{ fontStyle: 'italic', color: '#C29A73' }}>egentlig</span> har brug for
          </h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 32, textAlign: 'left' }}>
            {[
              ...
              <div key={label} style={{ borderTop: '1px solid rgba(255,255,255,0.12)', paddingTop: 24 }}>
      ...
      <section id="reviews" style={{ padding: '80px 24px', maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          <p style={{ fontSize: '0.75rem', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#C29A73', marginBottom: 12 }}>Hvad siger familierne?</p>
          <h2 style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', fontSize: 'clamp(2rem, 5vw, 3.5rem)', fontWeight: 400, color: '#2B1F16', lineHeight: 1.1 }}>
            Elsket af <span style={{ fontStyle: 'italic', color: '#C29A73' }}>tusinder</span>
          </h2>
        </div>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20 }}>
          {[
            { name: 'Maria S.', role: 'Mor til 8 måneder', text: 'Endelig én app der forstår hvad man har brug for som ny mor. Søvnloggen og tigerspring-funktionen er guld værd!' },
            { name: 'Camilla H.', role: 'Mor til 2 år', text: 'Jeg bruger appen hver dag. AI-eksperten har hjulpet mig mere end nogen søvnkonsulent nogensinde har.' },
            { name: 'Line & Thomas', role: 'Forældre til 4 mdr.', text: 'Det er rart at have en app der samler alt — kalender, søvn og viden. Anbefales varmt!' },
            { name: 'Sofie K.', role: 'Gravid i uge 28', text: 'Graviditetsdagbogen er SÅ fin. Jeg skrives i den ugentligt og gemmer alle mine mavebilleder.' },
            { name: 'Nadia B.', role: 'Mor til 6 måneder', text: 'Community-funktionen er det bedste. Det er dejligt at vide man ikke er alene om de lange nætter 💙' },
            { name: 'Mette L.', role: 'Mor til 1 år', text: 'Fantastisk app! Tigerspring-advarsler hjalp mig forstå min søn meget bedre i de svære uger.' },
          ].map(({ name, role, text }) => (
            <div key={name} style={{ backgroundColor: '#FFFDF9', border: '1px solid #EDE4DB', borderRadius: 24, padding: '28px 24px' }}>
              <div style={{ display: 'flex', gap: 2, marginBottom: 16 }}>
                {[...Array(5)].map((_, i) => <span key={i} style={{ color: '#C29A73', fontSize: '0.9rem' }}>★</span>)}
              </div>
      ...
      {/* ── FINAL CTA ── */}
      <section style={{
        background: 'linear-gradient(135deg, #C8A882 0%, #8A5A30 100%)',
        padding: '80px 24px',
        textAlign: 'center',
      }}>
        <h2 style={{ fontFamily: 'Cormorant Garamond, Georgia, serif', fontSize: 'clamp(2.2rem, 6vw, 4rem)', fontWeight: 400, color: '#fff', lineHeight: 1.1, marginBottom: 16 }}>
          Klar til bedre nætter?
        </h2>
        <p style={{ fontSize: '1.05rem', color: 'rgba(255,255,255,0.85)', marginBottom: 40, maxWidth: 480, margin: '0 auto 40px' }}>
          Hent LALATOTO gratis og bliv en del af fællesskabet af forældre der vælger ro, viden og omsorg.
        </p>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16, justifyContent: 'center' }}>
          <a href={APP_STORE_URL} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, backgroundColor: '#fff', borderRadius: 16, padding: '14px 28px', cursor: 'pointer', minWidth: 180 }}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="#1C1C1E">
                <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
              </svg>
              <div style={{ textAlign: 'left' }}>
