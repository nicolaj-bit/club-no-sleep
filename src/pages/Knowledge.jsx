        ...
        <div className="p-4 space-y-6">
          {searchResults.articles.length === 0 && searchResults.questions.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-slate-500">Ingen resultater for "{search}"</p>
            </div>
          ) : (
            <>
              ...
              {searchResults.questions.length > 0 && (
                <div>
                  <h2 className="text-sm font-medium text-slate-500 mb-3">Spørgsmål</h2>
                  <div className="space-y-2">
          ...
          <Tabs defaultValue="articles" className="w-full">
            ...
            <TabsContent value="faq" className="mt-4 space-y-2">
              {loadingArticles ? (
                ...
                <div className="text-center py-12">
                  <p className="text-slate-500">Ingen FAQ endnu</p>
                </div>
              ) : (
                faqs.map(article => (
                  <ArticleCard key={article.id} article={article} variant="compact" />
            ...
            <TabsContent value="questions" className="mt-4 space-y-4">
              ...
              {loadingQuestions ? (
                ...
                <div className="text-center py-8">
                  <p className="text-slate-500">Ingen spørgsmål endnu</p>
                </div>
              ) : (
                <div className="space-y-3">
                  {questions.map(q => (
