            ...
            {categories.map(cat => (
              <button
                ...
                style={activeCategory === cat
                  ? { background: 'var(--color-primary)', color: 'var(--color-primary-foreground)', boxShadow: '0 2px 8px rgba(160,120,90,0.35)', border: 'none' }
                  : { backgroundColor: 'transparent', color: 'var(--color-text-primary)', border: '1.5px solid var(--color-border)' }}
