        ...
        <div style={{ lineHeight: 1.8, color: '#5B3F2B', fontSize: '0.95rem' }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: 16 }}>
              <tbody>
                <tr style={{ borderTop: '1px solid #EDE4DB' }}>
                  <td style={{ fontWeight: 500, paddingRight: 24, paddingTop: 12, paddingBottom: 12, color: '#7A665A', fontSize: '0.9rem' }}>Virksomhed</td>
                  <td style={{ paddingTop: 12, paddingBottom: 12, color: '#2B1F16' }}>LALATOTO of Denmark ApS</td>
                </tr>
                <tr style={{ borderTop: '1px solid #EDE4DB' }}>
                  <td style={{ fontWeight: 500, paddingRight: 24, paddingTop: 12, paddingBottom: 12, color: '#7A665A', fontSize: '0.9rem' }}>Adresse</td>
                  <td style={{ paddingTop: 12, paddingBottom: 12, color: '#2B1F16' }}>Kulbyvej 16, 4270 Høng</td>
                </tr>
                <tr style={{ borderTop: '1px solid #EDE4DB' }}>
                  <td style={{ fontWeight: 500, paddingRight: 24, paddingTop: 12, paddingBottom: 12, color: '#7A665A', fontSize: '0.9rem' }}>Telefon</td>
                  <td style={{ paddingTop: 12, paddingBottom: 12, color: '#2B1F16' }}>72 15 66 86</td>
                </tr>
                <tr style={{ borderTop: '1px solid #EDE4DB' }}>
                  <td style={{ fontWeight: 500, paddingRight: 24, paddingTop: 12, paddingBottom: 12, color: '#7A665A', fontSize: '0.9rem' }}>E-mail</td>
                  <td style={{ paddingTop: 12, paddingBottom: 12, color: '#2B1F16' }}><a href="mailto:kundeservice@lalatoto.dk" style={{ color: '#C29A73', textDecoration: 'none', fontWeight: 500 }}>kundeservice@lalatoto.dk</a></td>
                </tr>
                <tr style={{ borderTop: '1px solid #EDE4DB' }}>
                  <td style={{ fontWeight: 500, paddingRight: 24, paddingTop: 12, paddingBottom: 12, color: '#7A665A', fontSize: '0.9rem' }}>CVR-nr.</td>
                  <td style={{ paddingTop: 12, paddingBottom: 12, color: '#2B1F16' }}>45 14 92 18</td>
                </tr>
              </tbody>
            </table>
          </section>
          ...
          <section style={{ marginBottom: 48, paddingBottom: 32, borderBottom: '1px solid #EDE4DB' }}>
            ...
            <ul style={{ marginTop: 16, marginBottom: 16, paddingLeft: 24, listStyleType: 'disc' }}>
              <li style={{ marginBottom: 10, color: '#5B3F2B' }}>Pris: 59 kr. pr. måned</li>
              <li style={{ marginBottom: 10, color: '#5B3F2B' }}>Abonnementet fornyes automatisk hver måned, indtil det opsiges.</li>
              <li style={{ marginBottom: 10, color: '#5B3F2B' }}>Alle beløb er angivet i danske kroner (DKK) og er inkl. moms, medmindre andet fremgår tydeligt ved tilmelding.</li>
              <li style={{ color: '#5B3F2B' }}>Der er ingen binding ud over den igangværende betalingsmåned.</li>
            </ul>
          ...
          <section style={{ marginBottom: 48, paddingBottom: 32, borderBottom: '1px solid #EDE4DB' }}>
            ...
            <ul style={{ marginTop: 16, marginBottom: 0, paddingLeft: 24, listStyleType: 'disc' }}>
              <li style={{ marginBottom: 10, color: '#5B3F2B' }}>Betalingen trækkes automatisk på den betalingsmetode, du angiver ved oprettelse.</li>
              <li style={{ marginBottom: 10, color: '#5B3F2B' }}>LALATOTO opbevarer ikke dine fulde kortoplysninger.</li>
              <li style={{ color: '#5B3F2B' }}>Hvis en betaling ikke kan gennemføres, kan adgangen til appen blive suspenderet, indtil gyldig betaling er modtaget.</li>
            </ul>
          </section>
          ...
          <section style={{ marginBottom: 48, paddingBottom: 32, borderBottom: '1px solid #EDE4DB' }}>
            ...
            <ul style={{ marginTop: 16, marginBottom: 0, paddingLeft: 24, listStyleType: 'disc' }}>
              <li style={{ marginBottom: 10, color: '#5B3F2B' }}>Du skal opbevare dine loginoplysninger sikkert.</li>
              <li style={{ marginBottom: 10, color: '#5B3F2B' }}>Du må ikke dele din konto med andre, medmindre LALATOTO udtrykkeligt har tilladt det.</li>
              <li style={{ marginBottom: 10, color: '#5B3F2B' }}>Du må ikke forsøge at skaffe dig uautoriseret adgang til appen, systemer eller andre brugeres data.</li>
              <li style={{ marginBottom: 10, color: '#5B3F2B' }}>Du må ikke kopiere, distribuere, videresælge eller på anden måde udnytte appens indhold kommercielt uden skriftlig tilladelse.</li>
              <li style={{ color: '#5B3F2B' }}>Du skal være mindst 18 år eller have samtykke fra en forælder/værge for at tegne et betalt abonnement.</li>
            </ul>
          </section>
