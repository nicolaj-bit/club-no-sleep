...
const WEEK_DATA = {
  ...
  21: {
    ...
    mom: {
      symptoms: ['Benlängtan og kramper om natten', 'Søvnbesvær', 'Strækmærker kan begynde', 'Hæmorider kan opstå', 'Svulmende fødder om aftenen'],
  ...
  37: {
    ...
    baby: {
      size: 'Ca. 48–49 cm',
      weight: 'Ca. 2,9 kg',
      description: 'Fuldbåren! Alle organer er modne. Lungserne er klar. Hjernen er klar. Immunsystemet er aktivt. Barnet øver sugebevægelser fortsat. Vernix tyndes ud. Klar til at møde verden.',
    ...
    <div className="min-h-screen pb-10" style={{ backgroundColor: 'var(--color-bg)' }}>
      ...
      <div className="px-4 pt-5 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          {prevWeek ? (
            <Link
              to={`/PregnancyWeekDetail?week=${prevWeek}`}
              className="rounded-2xl p-4 flex items-center gap-2 border"
          ...
          {nextWeek ? (
            <Link
              to={`/PregnancyWeekDetail?week=${nextWeek}`}
              className="rounded-2xl p-4 flex items-center justify-end gap-2 border"
              style={{ backgroundColor: 'var(--color-bg-card)', borderColor: 'var(--color-border)' }}
            >
